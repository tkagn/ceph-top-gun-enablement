...
image::./images/ceph101-crushhashdetail.png[CRUSH Hashing mechanism, align="center"]
...
image::./images/ceph101-dataprotection.png[Replicated Pools vs Erasure Coded Pools, scaledwidth="70%", align="center"]
...
.Pools and `PGs`
image::./images/ceph101-thefullpicture-new.png[From Object to OSD, scaledwidth="75%", align="center"]
...
.Data Distribution
image::./images/ceph101-rbdlayout.png[RADOS Block Device Layout, align="center"]
